...
folderLocation="/opt/cisco/secureclient/vpn/profile/"
#if [[ -d "$folderLocation" ]]; then
#	cd $folderLocation
#	echo "$folderLocation exists, checking for file"
#	if [[ ! -e "Fan_VPN_Profiles.xml" ]]; then
...
#	fi
#else
#	echo "$folderLocation does not exist"
#	mkdir $folderLocation
#	echo "$folderLocation created"
#fi

cd $folderLocation
echo "moved to folder location"
rm *.xml
