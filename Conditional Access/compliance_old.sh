...
EOS
                                                                                                ...
                                                                                                if [[ $result_value == "Welcome to Emerson Collective" ]]; then
                                                                                                    ...
                                                                                                    /usr/bin/logger "mSCP: 13_06_26_23 - system_settings_loginwindow_loginwindowtext_enable passed (Result: $result_value, Expected: "{'string': 'center for internet security test message'}")"
                                                                                                else
                                                                                                    if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
                                                                                                        ...
                                                                                                        /usr/bin/logger "mSCP: 13_06_26_23 - system_settings_loginwindow_loginwindowtext_enable failed (Result: $result_value, Expected: "{'string': 'center for internet security test message'}")"
                                                                                                    else
                                                                                                        ...
                                                                                                        /usr/bin/defaults write "$audit_plist" system_settings_loginwindow_loginwindowtext_enable -dict-add finding -bool YES
                                                                                                        /usr/bin/logger "mSCP: 13_06_26_23 - system_settings_loginwindow_loginwindowtext_enable failed (Result: $result_value, Expected: "{'string': 'center for internet security test message'}") - Exemption Allowed (Reason: "$exempt_reason")"
                                                                                                        /bin/sleep 1
                                                                                                    fi
                                                                                                fi
